...
export function canFreePrisoner(
  ...
  if(petDogIsPresent){
    if(prisonerIsAwake){
      if(knightIsAwake === true && archerIsAwake === true) return false;
      if(knightIsAwake === false && archerIsAwake === false) return true;
      if(knightIsAwake === false && archerIsAwake === true) return false;
      if(knightIsAwake === true && archerIsAwake === false) return true;
    }else{
      if(knightIsAwake === true && archerIsAwake === true) return false;
      if(knightIsAwake === false && archerIsAwake === false) return true;
      if(knightIsAwake === false && archerIsAwake === true) return false;
